...
class TNMClassification(BaseModel):
    ...
    def __str__(self):
        return str({'M': self.M, 'reasoning': self.reasoning})
...
def main():
    ...
    parser.add_argument('--prompt', type=str, default='prompts/sample_prompt.txt',
                      help='Path to prompt file (default: prompts/sample_prompt.txt)')
